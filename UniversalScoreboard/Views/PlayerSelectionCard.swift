...
// PointBoard
//
// Card de sélection des joueurs (copie conforme de PlayersCard)
// Sprint 0 - V3.0
//
// Rôle :
...
// MARK: - PlayerSelectionCard (Style météo) — CTA "Ajouter joueur" top-right
...
#Preview("PlayerSelectionCard — 2 joueurs") {
    PlayerSelectionCard(
        playerCount: 2,
        maxPlayers: 20,
...
#Preview("PlayerSelectionCard — 4 joueurs") {
    PlayerSelectionCard(
        playerCount: 4,
        maxPlayers: 20,
...
#Preview("PlayerSelectionCard — 0 joueur") {
    PlayerSelectionCard(
        playerCount: 0,
        maxPlayers: 20,
        playerNames: [],
